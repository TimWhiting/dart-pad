...
class DartHighlighter extends CodeEditingValueHighlighterBase {
  var _totalOffset = 0;
  var kCodeStyle = TextStyle(fontSize: 16.0, color: Colors.green);
  var plainStyle = TextStyle(fontSize: 16.0, color: Colors.white);
  ...
  CodeEditingValue parse(
    ...
    if (ls.length > 1) {
      newValue = newValue.copyWith(
          value: TextSpan(text: "", style: plainStyle, children: ls),
